...
<p><strong>Important</strong>: Everything about this website is public, do not record any passwords or other sensitive information here!</p>
...
<p><a href="#table-of-contents"><strong>Table of Contents</strong></a></p>
<p>After forking the repository, you can add a new Markdown file, you can follow these steps.</p>
<ol>
...
<p><a href="#table-of-contents"><strong>Table of Contents</strong></a></p>
<p>If you want your Markdown changes to be implemented quickly, you can take the extra step of publishing your Markdown file to HTML before submitting your pull request. To do this, follow these steps.</p>
<ol>
<li>Open the right hand menu by clicking on the StackEdit logo in the top right of the page.</li>
...
<p><a href="#table-of-contents"><strong>Table of Contents</strong></a></p>
<p>If you’ve made all the desired changes/additions to the guide’s Markdown (and optionally <a href="#publishing-your-file">published the result to HTML</a>), it’s time to submit your changes for consideration. Do this by navigating to your fork of the grad guide repository at <code>github.com/&lt;username&gt;/uoftgasa.github.io</code>, where <code>&lt;username&gt;</code> is your github username.</p>
<ol>
