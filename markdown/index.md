...
- **Filmographer**
	- Films the talk at each AstroTour, and uploads it to YouTube.
- **Photographer**
...
There are quite a few department events that occur on a weekly basis, which can be divided into those with a scientific focus, and those t
...
- **St Clair - \$**
	- North of St George
	- Centered on St Clair and Bathurst
	- Time to [St George](#st-george)
- **Trinity Bellwoods -\$\$**
- **Waterfront -\$\$\$**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcwMzk5NDQwNyw3ODcyODU1NywtNzk2OD
